...
if ($selectedCustomerId <= 0 || $selectedInvoiceId <= 0) {
    ...
    $invoiceStmt = $pdo->prepare("
        ...
        FROM customer_invoices si
        INNER JOIN customers s ON s.id = si.customer_id
...
<head>
    ...
    <title>طباعة فاتورة العميل - <?php echo e($store['name']); ?></title>
    <style>
        :root {
            color-scheme: light;
        }
...
<body>
    <div class="print-page">
        <div class="print-actions">
            <a class="button-link secondary" href="customer_invoice_details.php?customer_id=<?php echo (int) $selectedCustomerId; ?>&invoice_id=<?php echo (int) $selectedInvoiceId; ?>">⬅ الرجوع للتفاصيل</a>
            <?php if ($error === ''): ?>
        ...
        <?php else: ?>
            <div class="invoice-header">
                <div class="store-block">
                    ...
                    <div>
                        ...
                        <p class="muted">فاتورة بيع قابلة للطباعة</p>
                    </div>
                </div>

                <div class="invoice-title-block">
                    <div>
                        <h2>فاتورة العميل رقم <?php echo (int) $selectedInvoice['id']; ?></h2>
            ...
            <div class="meta-grid">
                <div class="meta-box">
                    <p>اسم العميل</p>
                    <strong><?php echo e($selectedInvoice['customer_name']); ?></strong>
                </div>
                <div class="meta-box">
                    <p>رقم تليفون العميل</p>
                    <strong><?php echo e($selectedInvoice['customer_phone']); ?></strong>
                </div>
                <div class="meta-box">
